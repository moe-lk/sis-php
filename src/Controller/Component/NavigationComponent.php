...
class NavigationComponent extends Component
{
    ...
    public function buildNavigation()
    {
        ...
        $columns = $this->array_column($navigations, 'title');
        $excluded = array_intersect($columns, $excludedPlugins);
        $navigations = array_diff_key($navigations, $excluded);
        $columns = $this->array_column($navigations, 'params');
        $columns = $this->array_column($columns, 'plugin');
        $excluded = array_intersect($columns, (array) array_keys($excludedPlugins));
        $navigations = array_diff_key($navigations, $excluded);
        $columns = $this->array_column($navigations, 'title');
        $excluded = array_intersect($columns, (array) array_keys($excludedPlugins));
        $navigations = array_diff_key($navigations, $excluded);
