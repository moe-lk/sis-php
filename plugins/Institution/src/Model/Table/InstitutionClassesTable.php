...
class InstitutionClassesTable extends ControllerActionTable
{
	...
	$events['ControllerAction.Model.delete.afterAction'] = ['callable' => 'deleteAfterAction', 'priority' => 10];
        //$events['ControllerAction.Model.edit.beforeAction'] = ['callable' => 'editBeforeAction', 'priority' => 100];
	return $events;
    }
  ...
  //	$staffId = $this->Auth->user('id');
    ...
    ******************************************************************************************************************/
    public function viewBeforeAction(Event $event, ArrayObject $extra)
    {
        ...
        $this->setFieldOrder([
            'academic_period_id', 'name', 'institution_shift_id', 'education_grades', 'no_of_students','total_male_students', 'total_female_students',
            'total_students', 'staff_id', 'secondary_staff_id', 'multigrade', 'students'
        ]);
    }
