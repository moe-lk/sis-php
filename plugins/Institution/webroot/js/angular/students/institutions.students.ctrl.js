...
function InstitutionStudentController($location, $q, $scope, $window, $filter, UtilsSvc, AlertSvc, SgTreeSvc, AggridLocaleSvc, InstitutionsStudentsSvc, $rootScope) {
    ...
    //StudentController.Student.having_bc = 1 ;
    ...
    StudentController.changeBC = changeBC;
...
//    StudentController.selectedStudentData.having_bc =  StudentController.BCOptions.availableOptions[1];
    ...
    function changeDivision() {
     ...
     function changeBC() {
        var studentData = StudentController.selectedStudentData;
        if (studentData.hasOwnProperty('having_bc')) {
            var bcOptions = StudentController.BCOptions.availableOptions;
            for (var i = 0; i < bcOptions.length; i++) {
                if (bcOptions[i].id == studentData.having_bc) {
                    studentData.having_bc_yn = {
                        name: bcOptions[i].name,
                        id: bcOptions[i].id
                    };
                }
            }
	...
	newStudentData['identity_number'] = studentData['area_administrative_id'] + '' + studentData.identity_number + '' + formatMonthYear(new Date(studentData.date_of_birth));
          ...
          newStudentData['identity_number']  = null;		
	}
	if (!StudentController.externalSearch) {
    ...
    function validateNewUser() {
        ...
        if (StudentController.selectedStudentData.having_bc_yn.id == 2 && (StudentController.selectedStudentData.area_administrative_id == "" || StudentController.selectedStudentData.area_administrative_id == null)) {
            StudentController.postResponse.error.area_administrative_id = empty;
            remain = true;
        }
        if (StudentController.selectedStudentData.having_bc_yn.id == 2 && (StudentController.selectedStudentData.area_administrative_district == "" || StudentController.selectedStudentData.area_administrative_district == null)) {
	...
	if (StudentController.selectedStudentData.date_of_birth == '') {
        ...
        if (StudentController.selectedStudentData.having_bc_yn.id = 2 && StudentController.StudentNationalities == 1 && (StudentController.Student.nationality_id == '' || StudentController.Student.nationality_id == undefined)) {
            remain = true;
        }
