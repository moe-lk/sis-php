...
class WorkflowsController extends AppController
{
    public function initialize()
    {
        ...
        if (Configure::read('schoolMode') == 'Community') {
            $this->ControllerAction->models = [
                'Workflows' => ['className' => 'Workflow.Workflows', 'options' => ['deleteStrategy' => 'transfer'], 'actions' => ['index', 'view']],
                'Steps' => ['className' => 'Workflow.WorkflowSteps', 'options' => ['deleteStrategy' => 'restrict'], 'actions' => ['index', 'view']],
                'Actions' => ['className' => 'Workflow.WorkflowActions', 'actions' => ['index', 'view']],
                'Statuses' => ['className' => 'Workflow.WorkflowStatuses', 'actions' => ['index', 'view']],
            ];
        } else {
            $this->ControllerAction->models = [
