...
class POCOR4424 extends AbstractMigration
{
    public function up()
    {
        $this->execute('CREATE TABLE `z_4424_institution_classes` LIKE `institution_classes`');
        $this->execute('INSERT INTO `z_4424_institution_classes` SELECT * FROM `institution_classes`');
